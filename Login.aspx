                            ...
                            <div class="modal-body" style="width: 600px">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <ul>
                                            <li>
                                                <p>To go back to the sign in page and login with another username, Click on Close</p>
                                            </li>
                                            <li>
                                                <p>To disconnect the opened session and continue with the login, click on Force Sign In</p>
                                            </li>
                                        </ul>
