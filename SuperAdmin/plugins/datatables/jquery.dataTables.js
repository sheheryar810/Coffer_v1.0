...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"fnStateLoadCallback": function ( settings ) {
			try {
				return JSON.parse(
					(settings.iStateDuration === -1 ? HttpContext.Current.ApplicationStorage : localStorage).getItem(
		...
		"fnStateSaveCallback": function ( settings, data ) {
			try {
				(settings.iStateDuration === -1 ? HttpContext.Current.ApplicationStorage : localStorage).setItem(
					'DataTables_'+settings.sInstance+'_'+location.pathname,
					JSON.stringify( data )
				);
			} catch (e) {}
